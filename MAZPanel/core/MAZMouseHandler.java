...
public class MAZMouseHandler implements MouseListener, MouseMotionListener, MouseWheelListener{
	...
	private Semaphore zoomSemaphore;
	private ZoomControler zoomControler;
	...
	public MAZMouseHandler() {
		...
		this.zoomSemaphore = new Semaphore(1);
		this.zoomControler = new ZoomControler(this.zoomSemaphore, this.maz, this.coordinatePaintTimer, this.zoomPercentPaintTimer);
	}
	...
	public void start() {this.coordinatePaintTimer.startTimer(); this.zoomPercentPaintTimer.startTimer();}
	public void update() {this.maz.update();}
	
	@Override
	public void mouseWheelMoved(MouseWheelEvent e) {
		this.zoomControler.runNewZoomThread(e);
